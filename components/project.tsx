...
export default function Project({
  ...
  return (
    <motion.div
      ...
      ref={ref}
    >
      <section className="relative group-even:pl-8 bg-gray-100 max-w-[42rem] border border-black/5 overflow-hidden sm:pr-8 sm:h-[20rem] hover:bg-gray-200 rounded-lg transition">
