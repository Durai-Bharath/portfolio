        ...
        return __async(this, arguments, function*(payload, options = {}) {
            for (const email of payload){
                if (email.react) {
                    if (!this.renderAsync) {
                        try {
                            const { renderAsync } = yield __turbopack_context__.r("[project]/node_modules/@react-email/render/dist/node/index.mjs [app-rsc] (ecmascript, async loader)")(__turbopack_context__.i);
...
//# sourceMappingURL=node_modules_d2185b8e._.js.map